...
| Lab | Date | Slides | Goals | Homework |\
|-----|------|--------|-------|----------|
...
| **04** | 24.10. | [pdf](../data/2025-26/cpp/ex04.pdf) | using, const/constexpr, ownership, special methods | **by 30.11. 5:00:** Implement class C (1p), 3D matrix (3p) |
| **05** | 31.10. | [pdf](../data/2025-26/cpp/ex05.pdf) | Declaration, definition, sequence containers, iterators | **by 6.11. 5:00:** Summing program (1p), N-in-row game (3p) |
| **06** | 07.11. |  |  |  |
| **07** | 14.11. |  |  |  |
| **08** | 21.11. |  |  |  |
| **09** | 28.11. |  |  |  |
