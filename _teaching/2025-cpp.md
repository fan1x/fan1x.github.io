...
| **10** | 05.11. | exceptions, noexcept, RAII, std::optional, std::expected |  | **by 11.12. 5:00:** make all previous containers (poly-)vector, linked-list, matrix (each 1p) properly handling exceptions |
| **11** | 12.11. |  |  |  |
| **12** | 19.11. |  |  |  |
| **13** | 09.01. |  |  |  |
